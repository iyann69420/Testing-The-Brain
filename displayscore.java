...
public class displayscore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(displayscore.this, start.class);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(displayscore.this, "Submitted: " + playerName, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void insertScore(String name, int score, String time) {
        ...
        values.put(DatabaseHelper.COLUMN_DIFFICULTY, "Easy");
