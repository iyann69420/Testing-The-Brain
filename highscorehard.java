...
public class highscorehard extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(highscorehard.this, start.class);
        ...
        goHomeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(highscorehard.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(highscorehard.this, "Submitted: " + playerName, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void insertScore(String name, int score, String time) {
        ...
        values.put(DatabaseHelper.COLUMN_DIFFICULTY, "Hard");
