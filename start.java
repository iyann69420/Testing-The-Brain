...
public class start extends AppCompatActivity {
    ...
    private void onTimeUp() {
        ...
        if (!backButtonPressed) {
            Intent intent = new Intent(start.this, timesup.class);
    ...
    private List<String> getRelevantWords(int questionIndex) {
        ...
        switch (questionIndex) {
            case 0:
                relevantWords.add("Madrid");
                relevantWords.add("Vienna");
                relevantWords.add("Berlin");
                break;
            case 1:
                relevantWords.add("Vincent van Gogh");
                relevantWords.add("Pablo Picasso");
                relevantWords.add("Michelangelo");
                break;
            case 2:
                relevantWords.add("Uranus");
                relevantWords.add("Saturn");
                relevantWords.add("Neptune");
                break;
            case 3:
                relevantWords.add("Ni");
                relevantWords.add("Cr");
                relevantWords.add("Sg");
                break;
            case 4:
                relevantWords.add("Denmark");
                relevantWords.add("Australia");
                relevantWords.add("Sweden");
                break;
            case 5:
                relevantWords.add("Charlotte Brontë");
                relevantWords.add("Mary Shelley");
                relevantWords.add("Charles Dickens");
                break;
            case 6:
                relevantWords.add("Mount Fuji");
                relevantWords.add("Mount Helens");
                relevantWords.add("Mount Vesuvius ");
                break;
            case 7:
                relevantWords.add("Howard Florey");
                relevantWords.add("Ernst Chain");
                relevantWords.add("Louis Pasteur");
                break;
            case 8:
                ...
                break;
            case 9:
                relevantWords.add("Au");
                relevantWords.add("He");
                relevantWords.add("Ni");
                break;
            default:
                break;
    ...
    private void checkAnswer(String selectedOption) {
        ...
        if (currentQuestionIndex < questions.length) {
            ...
            if (timerFinished ) {
                ...
                Intent intent = new Intent(start.this, displayscore.class);
