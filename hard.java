...
public class hard extends AppCompatActivity {
    ...
    private String[] questions = {
            "What is the official residence of the Prime Minister of Australia?",
            "Who painted the masterpiece 'The Persistence of Memory'?",
            "Which organ is responsible for the production of bile?",
            "What is the common name for the compound H2SO4?",
            "Which American filmmaker directed the critically acclaimed movie 'Full Metal Jacket'?",
            "Who is the author of the novel 'One Hundred Years of Solitude'?",
            "Which trench is the deepest point in the Pacific Ocean?",
            "Who is often referred to as the 'Father of Electrical Engineering'?",
            "From 1919 to 1933, the Weimar Republic was the government of what nation?",
            "What is the atomic number of the chemical element with the symbol Pt?"
    };
    ...
    private void onTimeUp() {
        ...
        if (!backButtonPressed) {
            Intent intent = new Intent(hard.this, timesuphard.class);
    ...
    private List<String> getRelevantWords(int questionIndex) {
        ...
        switch (questionIndex) {
            case 0:
                relevantWords.add("Kremlin");
                relevantWords.add("10 Downing Street");
                relevantWords.add("Blue House");
                break;
            case 1:
                relevantWords.add("René Magritte");
                relevantWords.add("Joan Miró");
                relevantWords.add("Claude Monet");
                break;
            case 2:
                relevantWords.add("Pancreas");
                relevantWords.add("Stomach");
                relevantWords.add("Kidney");
                break;
            case 3:
                relevantWords.add("Nitric Acid");
                relevantWords.add("Hydrochloric Acid");
                relevantWords.add("Carbonic Acid");
                break;
            case 4:
                relevantWords.add("Martin Scorese");
                relevantWords.add("Quentin Tarantino");
                relevantWords.add("Alfred Hitchcock");
                break;
            case 5:
                relevantWords.add("Julio Cortázar");
                relevantWords.add("Mario Vargas Llosa");
                relevantWords.add("Jorge Luis Borges");
                break;
            case 6:
                relevantWords.add("Philippine Trench");
                relevantWords.add("Tonga Trench");
                relevantWords.add("Kuril–Kamchatka Trench");
                break;
            case 7:
                relevantWords.add("Thomas Edison");
                relevantWords.add("Isaac Newton");
                relevantWords.add("Nikola Trbojevich");
                break;
            case 8:
                relevantWords.add("Russia");
                relevantWords.add("Poland");
                relevantWords.add("Austria");
                break;
            case 9:
                relevantWords.add("65");
                relevantWords.add("83");
                relevantWords.add("99");
                break;
    ...
    private void checkAnswer(String selectedOption) {
        ...
        if (currentQuestionIndex < questions.length) {
            ...
            if (timerFinished ) {
                ...
                Intent intent = new Intent(hard.this, highscorehard.class);
