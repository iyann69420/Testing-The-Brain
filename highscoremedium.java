...
public class highscoremedium extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retryButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(highscoremedium.this, start.class);
        ...
        goHomeButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(highscoremedium.this, MainActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(highscoremedium.this, "Submitted: " + playerName, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void insertScore(String name, int score, String time) {
        ...
        values.put(DatabaseHelper.COLUMN_DIFFICULTY, "Medium");
